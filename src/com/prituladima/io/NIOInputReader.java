...
public class NIOInputReader {
    private boolean finished = false;

//    private InputStream stream;
//    private byte[] buf;
    private static int bufferSize = 8192;
    ScatteringByteChannel byteChannel;
    ByteBuffer byteBuffer;
    private int curChar;
    private int numChars;
    private NIOInputReader.SpaceCharFilter filter;

    public NIOInputReader(FileInputStream stream) {
        byteChannel = stream.getChannel();
    ...
    public byte read() {
        ...
        if (curChar >= numChars) {
            ...
            try {
                byteBuffer.clear();
                numChars = byteChannel.read(byteBuffer);
                byteBuffer.flip();
            } catch (IOException e) {
                throw new InputMismatchException();
            }
